...
// 短信应用SDK AppID
$appid = 1400085730; // 1400开头

// 短信应用SDK AppKey
$appkey = "5dd0ce901528d2a9397cae982b99f07f";

// 需要发送短信的手机号码
$phoneNumbers = ["15209230125"];

// 短信模板ID，需要在短信应用中申请
$templateId = 112052;  // NOTE: 这里的模板ID`7839`只是一个示例，真实的模板ID需要在短信控制台中申请

// 签名
$smsSign = "煋云科技"; // NOTE: 这里的签名只是示例，请使用真实的已申请的签名，签名参数使用的是`签名内容`，而不是`签名ID`
/* 
// 单发短信
try {
